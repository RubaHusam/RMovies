              ...
              <div className='border-0 rounded-lg shadow-lg  relative flex flex-col w-full bg-white outline-none focus:outline-none'>
                ...
                <div className='fixed w-1920 h-1080'>
                  ...
                  <div className='flex items-center justify-center p-5 border-b border-solid border-slate-200 rounded-t'>
                    ...
                    <button
                      className='text-red-500 justify-end background-transparent font-bold uppercase px-6 py-2 text-sm outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150'
                      type='button'
