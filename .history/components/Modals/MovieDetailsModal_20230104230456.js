...
export default function MovieDetailsModal({
  ...
  return (
    <>
      {showModal ? (
        <>
          <div className='  justify-center sm:items-center flex overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none'>
            <div className=' bg-current bg-gradient-to-l from-[#0b0c0f] relative w-1920 my-6 mx-auto max-w-6xl'>
              {/*content*/}
